...
class CarpoolRequestApprovedNotification extends Notification
{
    use Queueable;
    ...
    public function toMail(object $notifiable): MailMessage
    {
        if($notifiable->hasRole('carpool_driver')){
            return (new MailMessage)
                ->subject(__('Carpool Request Approved'))
                ->greeting(__('Hello, ' . $notifiable->name . '!'))
                ->line(__('A carpool request has been approved.'))
        ...
        return (new MailMessage)
            ->subject(__('Carpool Request Approved'))
            ->greeting(__('Hello, ' . $notifiable->name . '!'))
            ->line(__('Your carpool request has been approved.'))
            ->line(__('Title: ' . $this->carpoolRequest->title))
            ->line(__('Description: ' . $this->carpoolRequest->description))
            ->line(__('Schedule Date: ' . $this->carpoolRequest->departure_date))
            ->line(__('Schedule Time: ' . $this->carpoolRequest->departure_time))
    ...
    public function toArray(object $notifiable): array
    {
        if($notifiable->hasRole('carpool_driver')){
            return [
                'subject' => 'Carpool Request Approved',
                'message' => 'A carpool request has been approved. Click this message to view the request.',
        ...
        return [
            'subject' => 'Carpool Request Approved',
            'message' => 'Your carpool request has been approved. Click this message to view the request.',
