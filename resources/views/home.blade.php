...
<body class="font-montserrat">
    ...
    <!-- Headline -->
    <section class="flex flex-col items-center bg-gray-100 dark:bg-gray-900">
    ...
    <section class="flex flex-col items-center justify-center py-8 bg-white dark:bg-gray-950">
        <div class="w-4/5 lg:mb-16">
            <h2 class="py-4 mb-4 text-4xl font-extrabold text-center text-gray-900 dark:text-white">Unlock the Future of
                Transportation</h2>
            <p class="text-center text-gray-800 sm:text-xl dark:text-gray-400">Why should you use StrathPort?</p>
        </div>
        <div class="max-w-screen-xl px-4 py-4 mx-auto sm:pb-16 sm:pt-4 lg:px-6">
            <div class="space-y-8 md:grid md:grid-cols-2 lg:grid-cols-3 md:gap-12 md:space-y-0">
                <div>
                    <div
                        class="flex items-center justify-center w-10 h-10 mb-4 rounded-full bg-fuchsia-100 lg:h-12 lg:w-12 dark:bg-fuchsia-900">
                        <svg class="w-5 h-5 text-fuchsia-600 lg:w-6 lg:h-6 dark:text-fuchsia-300" aria-hidden="true"
                    ...
                    <p class="text-gray-800 dark:text-gray-400">On changes or delays in transport schedules</p>
                </div>
                <div>
                    <div
                        class="flex items-center justify-center w-10 h-10 mb-4 rounded-full bg-fuchsia-100 lg:h-12 lg:w-12 dark:bg-fuchsia-900">
                    ...
                    <p class="text-gray-800 dark:text-gray-400">For simple navigation throughout the system</p>
                </div>
                <div>
                    <div
                        class="flex items-center justify-center w-10 h-10 mb-4 rounded-full bg-fuchsia-100 lg:h-12 lg:w-12 dark:bg-fuchsia-900">
                    ...
                    <p class="text-gray-800 dark:text-gray-400">By providing regular updates on availability of vehicles
                        and drivers</p>
                </div>
            </div>
        </div>
    ...
    <!-- Features -->
    <section class="flex flex-col items-center justify-center py-8 md:flex-row bg-gray-100 dark:bg-gray-900">
        <div class="flex-grow px-8 md:w-1/5 md:flex-col md:items-center md:flex lg:px-12">
            ...
            <p class="text-center text-gray-800 sm:text-xl dark:text-gray-400">What does StrathPort offer?</p>
        </div>
        <div class="flex flex-grow md:w-4/5">
            <div class="px-4 py-4 space-y-8 md:grid md:grid-cols-2 lg:px-6 md:gap-12 md:space-y-0">
                <div class="flex-grow md:items-center md:flex md:flex-col">
                    <div
                        class="flex items-center justify-center w-10 h-10 mb-4 bg-teal-100 rounded-full lg:h-12 lg:w-12 dark:bg-teal-900">
                        <svg class="w-5 h-5 text-teal-600 lg:w-6 lg:h-6 dark:text-teal-300" aria-hidden="true"
                    ...
                    <p class="text-gray-800 md:text-center dark:text-gray-400">To make requests and arrangements for
                        transport</p>
                </div>
                <div class="flex-grow md:flex-col md:items-center md:flex">
                    <div
                        class="flex items-center justify-center w-10 h-10 mb-4 bg-teal-100 rounded-full lg:h-12 lg:w-12 dark:bg-teal-900">
                        <svg class="w-5 h-5 text-teal-600 lg:w-6 lg:h-6 dark:text-teal-300" viewBox="0 0 24 24"
                    ...
                    <p class="text-gray-800 md:text-center dark:text-gray-400">An alternative to transport booking.
                        Search for and contact available drivers!</p>
                </div>
                <div class="md:items-center md:flex-col md:flex">
                    ...
                    <p class="text-gray-800 md:text-center dark:text-gray-400">Check out school transport schedules on
                        the go</p>
                </div>
                <div class="md:items-center md:flex-col md:flex">
                    <div
                    ...
                    <p class="text-gray-800 md:text-center dark:text-gray-400">Get notified of updated requests and
                        transport schedules!</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="bg-white dark:bg-gray-950">
        <div class="items-center max-w-screen-xl px-4 py-8 mx-auto lg:py-16 lg:px-6">
            <div class="font-light text-gray-500 sm:text-lg dark:text-gray-400">
                ...
                <p class="mb-4 text-gray-800 dark:text-gray-200">Thoughts from our users...</p>
            </div>
            <!-- User quotes -->
            <div class="mt-10 space-y-8 md:gap-8 md:grid-cols-3 md:grid md:space-y-0">
                <div
                    class="flex-grow p-4 border-pink-300 rounded shadow-md bg-pink-50 dark:bg-pink-100 md:justify-between md:flex-col md:flex">
                    <p class="mb-8 text-gray-800">"StrathPort has revolutionized our school
                        transport. Scheduling is a breeze, and we've significantly improved on-time pickups and
                        drop-offs. Highly recommended!"</p>
                    <div class="flex justify-">
                        <div
                            class="flex items-center justify-center w-10 h-10 mb-4 rounded-full bg-fuchsia-300 lg:h-12 lg:w-12 dark:bg-fuchsia-400">
                            <svg class="w-5 h-5 text-fuchsia-900 lg:w-6 lg:h-6 dark:text-fuchsia-800"
                        ...
                        <div class="flex flex-col flex-end ml-8">
                ...
                <div
                    class="flex-grow p-4 border-pink-300 rounded shadow-md bg-pink-50 dark:bg-pink-100 md:flex-col md:flex md:justify-between">
                    <p class="mb-8 text-gray-800">"This system is a lifesaver! It's easy to use, and the customizable
                        features allow us to tailor it perfectly to our school's needs. Our parents love the peace of
                        mind it provides"</p>
                    <div class="flex">
                        <div
                            class="flex items-center justify-center w-10 h-10 mb-4 rounded-full bg-fuchsia-300 lg:h-12 lg:w-12 dark:bg-fuchsia-400">
                ...
                <div
                    class="flex-grow p-4 border-pink-300 rounded shadow-md bg-pink-50 dark:bg-pink-100 md:justify-between md:flex-col md:flex">
                    <p class="mb-8 text-gray-800">"StrathPort has not only improved our efficiency but also reduced our
                        operational costs. We're thrilled with the results and the positive impact it's had on our
                        school community."</p>
                    <div class="flex">
                        <div
                            class="flex items-center justify-center w-10 h-10 mb-4 rounded-full bg-fuchsia-300 lg:h-12 lg:w-12 dark:bg-fuchsia-400">
        ...
        <div class="max-w-screen-xl mx-auto">
            <div class="md:flex md:justify-between">
                <div class="mb-6 md:mb-0">
                    <p class="mb-2 dark:text-gray-400">Template provided by:</p>
                ...
                <div class="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                    <div>
                        <h2 class="mb-6 text-sm font-semibold text-gray-900 uppercase dark:text-white">Project Info
                        </h2>
                        <ul class="text-gray-600 dark:text-gray-400">
                            ...
                            <li>
                                <a href="https://github.com/Fidelisaboke/StrathPort" class="hover:underline">GitHub
                                    Repo</a>
                            </li>
                        </ul>
                    </div>
                    <div>
                        <h2 class="mb-6 text-sm font-semibold text-gray-900 uppercase dark:text-white">Collaborators
                        </h2>
                        <ul class="text-gray-600 dark:text-gray-400">
                            <li class="mb-4">
            ...
            <div class="sm:flex sm:items-center sm:justify-between">
                <span class="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2024 <a href="#"
                        class="hover:underline">Fidel Isaboke and Lynn Githinji</a>. All Rights Reserved.
                </span>
