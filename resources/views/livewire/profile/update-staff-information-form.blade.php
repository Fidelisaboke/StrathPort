<x-form-section submit="update">
    ...
    <x-slot name="form">
        ...
        <div class="col-span-6 sm:col-span-4">
            <x-label for="staff_school_id" value="{{ __('Staff School ID') }}" />
            <x-input id="staff_school_id" type="text" class="block w-full mt-1" wire:model="state.staff_school_id" required autocomplete="staff_school_id" />
            @error('staff_school_id')
