<x-admin-app-layout>
    ...
    <div class="container grid w-3/5 px-6 mx-auto">
        <div class="items-center p-4 my-6">
            <form method="post" action="{{ route('admin.school_drivers.store') }}">
                @csrf
                <div class="overflow-hidden shadow sm:rounded-md">
                    <!-- First Name -->
                    <div class="px-4 py-5 bg-white sm:p-6">
                        <label for="first_name" class="block text-sm font-medium text-gray-700">First Name</label>
                        <input type="text" name="first_name" id="first_name" type="text" class="block w-full mt-1 rounded-md shadow-sm form-input"
                    ...
                    <div class="px-4 py-5 bg-white sm:p-6">
                        ...
                        <input type="text" name="last_name" id="last_name" type="text" class="block w-full mt-1 rounded-md shadow-sm form-input"
                               value="{{ old('last_name', '') }}" />
                        @error('last_name')
                            <p class="text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    ...
                    <div class="px-4 py-5 bg-white sm:p-6">
                        ...
                        <input type="text" name="phone" id="phone" type="text" class="block w-full mt-1 rounded-md shadow-sm form-input"
                               value="{{ old('phone', '') }}" />
                        @error('phone')
                            <p class="text-sm text-red-600">{{ $message }}</p>
                        @enderror
