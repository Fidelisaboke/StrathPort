<x-admin-app-layout>
    ...
    <div class="container grid p-6 mx-auto">
        <div class="grid gap-6 mb-8 md:grid-cols-2">
            <a href="{{ route('admin.transport_schedules.create') }}" class="flex justify-between p-4 text-sm font-semibold text-white rounded-lg shadow-md bg-fuchsia-600 hover:bg-fuchsia-700 max-w-max items -center focus:outline-none focus:shadow-outline-blue">
