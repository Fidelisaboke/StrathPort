<x-form-section submit="updateProfileInformation">
    ...
    <x-slot name="form">
        ...
        <div class="col-span-6 sm:col-span-4">
            ...
            <x-input id="secondary_email" type="text" class="block w-full mt-1" wire:model="state.secondary_email" required autocomplete="secondary_email" />
            <x-input-error for="secondary_email" class="mt-2" />
        </div>
        ...
        <div class="col-span-6 sm:col-span-4">
            ...
            <x-input id="phone" placeholder="+254123456789" type="text" class="block w-full mt-1" wire:model="state.phone" required autocomplete="phone" />
