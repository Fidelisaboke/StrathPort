    ...
    <div class="py-12">
        <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
            @if (Auth::user()->hasRole('student') || Auth::user()->hasRole('staff'))
                <a href="{{route('carpool_requests.create')}}" class="flex flex-row justify-center px-4 py-2 mx-8 mb-4 font-bold text-white rounded md:mx-0 md:inline-block bg-fuchsia-600 hover:bg-fuchsia-700">Create a Carpool Request</a>
            @endif            <!-- Search bar -->
