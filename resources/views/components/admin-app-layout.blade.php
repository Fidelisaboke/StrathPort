...
<body>
    <div x-data="{ sidebarOpen: false, notificationOpen: false, dropdownOpen: false, hasNotification: true }" class="flex h-screen bg-gray-200">
        ...
        <div class="flex flex-col flex-1 overflow-hidden">
            <header class="flex items-center justify-between px-6 py-4 bg-white border-b-4 border-fuchsia-600">
                <div class="flex items-center">
                    ...
                    <div class="relative mx-4 lg:mx-0">
                        ...
                        <input
                            class="w-32 py-2 pl-10 pr-4 placeholder-gray-500 bg-gray-100 border border-gray-200 rounded-lg lg:w-64 focus:bg-white focus:border-white focus:outline-none focus:shadow-outline"
                        ...
                        <x-dropdown align="right" width="48">
                            ...
                            <x-slot name="content">
                                ...
                                <form method="POST" action="{{ route('logout') }}" x-data>
                                    ...
                                    <x-dropdown-link href="{{ route('logout') }}" @click.prevent="$dispatch('logout')">
                                        {{ __('Log Out') }}
                                    </x-dropdown-link>
                                </form>
                            </x-slot>
