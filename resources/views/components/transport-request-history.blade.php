<div class="flex flex-col items-center p-2 border-black rounded">
    ...
    <div class="grid grid-cols-3 gap-8 p-4">
        <!-- Pending -->
        <div class="p-4 bg-yellow-600 shadow-xl sm:rounded-lg">
            <h3 class="text-center text-white lg:text-lg">Pending</h3>
            <p class="p-4 text-xl text-center text-white lg:text-2xl">{{$pending_count}}</p>
        </div>
        <!-- Approved -->
        <div class="p-4 bg-green-700 shadow-xl sm:rounded-lg">
            <h3 class="text-center text-white lg:text-lg">Approved</h3>
            <p class="p-4 text-xl text-center text-white lg:text-2xl">{{$approved_count}}</p>
        </div>
        <!-- Declined -->
        <div class="p-4 bg-red-700 shadow-xl sm:rounded-lg">
            <h3 class="text-center text-white lg:text-lg">Declined</h3>
