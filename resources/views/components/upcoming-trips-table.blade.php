@if (empty($transportScheduless) || $transportSchedules->isEmpty())
            ...
            <tbody>
                @foreach ($transportSchedules as $transportSchedule)
                    <tr>
                            ...
                            <div class="flex items-center gap-3">
                                <div class="flex flex-col">
                                    <p
                                        ...
                                        {{ $transportSchedule->description }}</p>
                                </div>
                            </div>
                        </td>
                        <td class="p-4 border-b border-blue-gray-50">
                        ...
                        <td class="p-4 border-b border-blue-gray-50">
                            <!-- view -->
                            <a href="{{ route('transport_schedules.show', $transportSchedule->id) }}"
